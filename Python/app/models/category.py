...
class MasterCategory(Base):
    ...
    CategoryCode = Column(String(20),   unique=True, nullable=False)   # Auto: CAT-001
    # CategoryName uniqueness is enforced in the SP for non-deleted rows only.
    CategoryName = Column(String(100),  index=True, nullable=False)
