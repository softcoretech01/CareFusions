-- ==============================================================================
-- Medicine Master Schema & Stored Procedure
-- ==============================================================================

-- 1. Master_MedicineCategory Lookup Table
...
INSERT IGNORE INTO Master_MedicineCategory (CategoryName) VALUES
('Tablets'),
('Capsules'),
('Syrups'),
('Injections'),
...
-- 3. SpMasterMedicine Stored Procedure
DELIMITER //
...
BEGIN
    ...
    ELSEIF p_Opt = 'GETBYID' THEN
        SELECT
            ...
            CreatedBy, CreatedDate, ModifiedBy, ModifiedDate
        FROM Master_Medicine
        WHERE MedicineId = p_MedicineId AND IsDeleted = 0;
