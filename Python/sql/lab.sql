...
INSERT IGNORE INTO admin.Master_LabTest
    (TestCode, TestName, SampleType, NormalRange, Unit,
     TestMethod, TurnaroundTime, TestPrice, Gst, RequiresApproval, CriticalValueAlert, Status, CreatedBy)
VALUES
    ('CBC',   'Complete Blood Count (CBC)', 'Blood', '4.5 - 11.0',  '10^3/uL', 'Automated Analyser', '2 hours',  350.00, 0, 0, 1, 'Active', 'Seed'),
    ('HB',    'Hemoglobin',                 'Blood', '12.0 - 15.5', 'g/dL',    'Photometric',        '1 hour',   150.00, 0, 0, 1, 'Active', 'Seed'),
    ('FBS',   'Fasting Blood Sugar',        'Blood', '70 - 100',    'mg/dL',   'GOD-POD',            '2 hours',  120.00, 0, 0, 1, 'Active', 'Seed'),
    ('LIPID', 'Lipid Profile',              'Blood', '0 - 200',     'mg/dL',   'Enzymatic',          '4 hours',  800.00, 0, 0, 0, 'Active', 'Seed'),
    ('CREAT', 'Serum Creatinine',           'Blood', '0.7 - 1.3',   'mg/dL',   'Jaffe',              '3 hours',  250.00, 0, 0, 1, 'Active', 'Seed'),
    ('TROP',  'Troponin I',                 'Blood', '0.0 - 0.4',   'ng/mL',   'Immunoassay',        '1 hour',   1200.00, 0, 1, 1, 'Active', 'Seed'),
    ('TSH',   'Thyroid Profile',            'Blood', '0.4 - 4.0',   'mIU/L',   'CLIA',               '6 hours',  600.00, 0, 0, 0, 'Active', 'Seed'),
    ('URIN',  'Urine Routine',              'Urine', NULL,       NULL,      'Microscopy',         '2 hours',  200.00, 0, 0, 0, 'Active', 'Seed');
