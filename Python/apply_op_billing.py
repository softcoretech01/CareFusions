...
def apply_sql_file(filename):
    ...
    with engine.connect() as con:
        # Handling DELIMITER manually since sqlalchemy doesn't support DELIMITER syntax directly well
        # Let's just create the tables and procedure manually here.
        tables = """
...
"""
        drop_sp = "DROP PROCEDURE IF EXISTS hospital.SpOpBilling"
        create_sp = """
...
if __name__ == "__main__":
    apply_sql_file('sql/op_billing.sql')
