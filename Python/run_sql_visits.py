...
def run_sql():
    with engine.begin() as conn:
        print("Creating PatientVisit table...")
        # Create Table
        table_sql = """
        ...
        print("Dropping existing SpPatientVisit if exists...")
        conn.execute(text("DROP PROCEDURE IF EXISTS registration.SpPatientVisit;"))

        print("Creating SpPatientVisit stored procedure...")
        sp_sql = """
