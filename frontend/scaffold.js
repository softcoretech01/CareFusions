...
const outDir = path.join(__dirname, 'src/pages/admin/masters');
...
fs.writeFileSync(path.join(__dirname, 'src/routes/new_routes.txt'), routeImports + '\n\n' + routeDefinitions);
console.log('Saved route imports to src/routes/new_routes.txt');
