...
interface EditMedicineFormProps {
  medicine: Medicine;
  onSave: (id: string, updatedData: Partial<Medicine>) => void;
  onCancel: () => void;
}

export const EditMedicineForm = ({ medicine, onSave, onCancel }: EditMedicineFormProps) => {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="flex-1 overflow-y-auto p-6 space-y-8">
        <section>
          <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">Edit Medicine Information</h3>
      ...
      <div className="p-4 border-t border-slate-100 bg-slate-50/50 flex justify-between items-center shrink-0">
        <Button variant="outline" color="secondary" onClick={() => setFormData(medicine)} icon={RefreshCw}>
          Reset
        </Button>
