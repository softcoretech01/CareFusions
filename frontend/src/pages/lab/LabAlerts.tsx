    ...
    .flatMap(order => 
      order.tests
        ...
        .map(test => ({
          ...
          time: test.completedAt || new Date().toISOString()
        }))
    )
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          {criticalAlerts.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-1">No Critical Alerts</h3>
              <p className="text-slate-500 text-sm">All critical lab results have been acknowledged.</p>
            </div>
          ) : (
              ...
              <div key={alert.testId} className="flex flex-col sm:flex-row gap-4 p-5 rounded-2xl border border-red-200 bg-red-50/40 hover:bg-red-50/60 transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-white p-4 rounded-xl border border-red-100 mt-3 flex flex-wrap gap-6 items-center">
                    ...
                    <div>
                      <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Result Value</p>
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-red-700">Notify physician immediately</p>
                    </div>
                  </div>
                </div>
              </div>
