...
import { FlagChip } from '../../../components/ui/DetailChips';
...
const emptyData: Omit<MinorOperationRecord, 'id' | 'serialNo'> = {
  operationCode: '',
  operationName: '',
  department: '',
  requirements: '',
...
export const MinorOperationMaster = () => {
  ...
  const [formData, setFormData] = useState<Omit<MinorOperationRecord, 'id' | 'serialNo'>>(emptyData);
  ...
  const handleCreateNew = () => {
    ...
    setFormData({
      ...emptyData,
      operationCode: `MIN-${nextId.toString().padStart(3, '0')}`
    });
    setErrors({});
    setIsFormOpen(true);
  };
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1">Minor Operation Name <span className="text-red-500">*</span></label>
