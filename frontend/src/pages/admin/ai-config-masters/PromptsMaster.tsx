...
const generateInitialData = () => {
  ...
  const names = mockNames['prompts'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Prompt Templates</h1>
          <p className="text-slate-500 mt-1">Manage and configure your prompt templates settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Prompt Templates` : `Create Prompt Templates`}
        maxWidth="xl"
      >
