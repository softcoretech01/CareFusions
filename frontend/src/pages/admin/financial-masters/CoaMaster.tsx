...
export const CoaMaster = () => {
  ...
  const { page, setPage, pageSize, total, paged } = usePagination(accountTypes);
        ...
        <>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-100 flex-1 flex flex-col overflow-hidden">
            <div className="p-4 border-b border-slate-100 flex flex-wrap gap-4 items-center justify-between">
              ...
              <button onClick={() => { setSearchTerm(''); setFilterType(''); }} title="Clear search & filters" className="p-2 border border-red-200 rounded-lg text-red-500 hover:bg-red-50 hover:border-red-300 transition-colors">
                <X className="w-4 h-4" />
              </button>
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      {paged.map(t => <option key={t} value={t}>{t}</option>)}
                    </select>
                  </div>
                </motion.div>
              )}
            ...
            <div className="flex-1 overflow-x-auto">
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-slate-100">
                  {isLoading ? (
                    <tr><td colSpan={5} className="px-4 py-8 text-center text-slate-500">Loading accounts...</td></tr>
