...
const generateInitialData = () => {
  ...
  const names = mockNames['coa'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and configure your chart of accounts settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Chart of Accounts` : `Create Chart of Accounts`}
        maxWidth="xl"
      >
