...
const generateInitialData = () => {
  ...
  const names = mockNames['cost-center'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Cost Centers</h1>
          <p className="text-slate-500 mt-1">Manage and configure your cost centers settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Cost Centers` : `Create Cost Centers`}
        maxWidth="xl"
      >
