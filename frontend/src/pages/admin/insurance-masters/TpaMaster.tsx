...
const generateInitialData = () => {
  ...
  const names = mockNames['tpa'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and configure your tpa master settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit TPA Master` : `Create TPA Master`}
        maxWidth="xl"
      >
