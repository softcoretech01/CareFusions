...
const generateInitialData = () => {
  ...
  const names = mockNames['insurance-provider'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Insurance Provider</h1>
          <p className="text-slate-500 mt-1">Manage and configure your insurance provider settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Insurance Provider` : `Create Insurance Provider`}
        maxWidth="xl"
      >
