...
const generateInitialData = () => {
  ...
  const names = mockNames['sample-type'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Sample Types</h1>
          <p className="text-slate-500 mt-1">Manage and configure your sample types settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Sample Types` : `Create Sample Types`}
        maxWidth="xl"
      >
