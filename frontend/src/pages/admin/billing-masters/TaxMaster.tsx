...
const generateInitialData = () => {
  ...
  const names = mockNames['tax'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Tax Master</h1>
          <p className="text-slate-500 mt-1">Manage and configure your tax master settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Tax Master` : `Create Tax Master`}
        maxWidth="xl"
      >
