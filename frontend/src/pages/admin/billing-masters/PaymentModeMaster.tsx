...
const generateInitialData = () => {
  ...
  const names = mockNames['payment-mode'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Payment Mode</h1>
          <p className="text-slate-500 mt-1">Manage and configure your payment mode settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Payment Mode` : `Create Payment Mode`}
        maxWidth="xl"
      >
