...
const generateInitialData = () => {
  ...
  const names = mockNames['medicine-category'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and configure your medicine category settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Medicine Category` : `Create Medicine Category`}
        maxWidth="xl"
      >
