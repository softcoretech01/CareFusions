...
const generateInitialData = () => {
  ...
  const names = mockNames['doctor-specialization'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Doctor Specialization</h1>
          <p className="text-slate-500 mt-1">Manage and configure your doctor specialization settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Doctor Specialization` : `Create Doctor Specialization`}
        maxWidth="xl"
      >
