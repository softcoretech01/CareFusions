...
const generateInitialData = () => {
  ...
  const names = mockNames['patient-category'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and configure your patient category settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Patient Category` : `Create Patient Category`}
        maxWidth="xl"
      >
