...
const generateInitialData = () => {
  ...
  const names = mockNames['blood-group'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and configure your blood group settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Blood Group` : `Create Blood Group`}
        maxWidth="xl"
      >
