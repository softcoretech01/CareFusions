...
const generateInitialData = () => {
  ...
  const names = mockNames['equipment'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and configure your equipment master settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Equipment Master` : `Create Equipment Master`}
        maxWidth="xl"
      >
