...
const generateInitialData = () => {
  ...
  const names = mockNames['radiology-service'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Radiology Services</h1>
          <p className="text-slate-500 mt-1">Manage and configure your radiology services settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Radiology Services` : `Create Radiology Services`}
        maxWidth="xl"
      >
