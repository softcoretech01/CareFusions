...
const generateInitialData = () => {
  ...
  const names = mockNames['consultation-type'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and configure your consultation type settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Consultation Type` : `Create Consultation Type`}
        maxWidth="xl"
      >
