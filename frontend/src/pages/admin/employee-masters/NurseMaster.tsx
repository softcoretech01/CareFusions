...
const generateInitialData = () => {
  ...
  const names = mockNames['nurse'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and configure your nurse master settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Nurse Master` : `Create Nurse Master`}
        maxWidth="xl"
      >
