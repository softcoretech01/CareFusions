...
const generateInitialData = () => {
  ...
  const names = mockNames['lab-technician'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and configure your lab technician master settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Lab Technician Master` : `Create Lab Technician Master`}
        maxWidth="xl"
      >
