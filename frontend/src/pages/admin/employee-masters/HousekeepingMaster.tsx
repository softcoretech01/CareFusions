...
const generateInitialData = () => {
  ...
  const names = mockNames['housekeeping'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
  ...
  return (
    ...
    >
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Housekeeping Master` : `Create Housekeeping Master`}
        maxWidth="xl"
      >
