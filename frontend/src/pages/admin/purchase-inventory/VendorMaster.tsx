...
const generateInitialData = () => {
  ...
  const names = mockNames['vendor'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage and configure your vendor master settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Vendor Master` : `Create Vendor Master`}
        maxWidth="xl"
      >
