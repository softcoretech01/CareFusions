...
const generateInitialData = () => {
  ...
  const names = mockNames['warehouse'] || ['Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta'];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Warehouse Master</h1>
          <p className="text-slate-500 mt-1">Manage and configure your warehouse master settings.</p>
        </div>
      ...
      <Modal
        ...
        title={selectedRecord ? `Edit Warehouse Master` : `Create Warehouse Master`}
        maxWidth="xl"
      >
