...
const emptyData: Omit<WarehouseRecord, 'id'> = { storeCode: '', storeName: '', storeType: 'Main Store', location: '', inCharge: '', contactNumber: '', status: 'Active' };
...
{"id":6,"storeCode":"STR-006","storeName":"Radiology Store","storeType":"Sub Store","location":"Ground Floor Radiology","inCharge":"Mr. Patel","contactNumber":"1006","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":7,"storeCode":"STR-007","storeName":"Emergency Store","storeType":"Sub Store","location":"Ground Floor ER","inCharge":"Sr. Anna","contactNumber":"1007","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":8,"storeCode":"STR-008","storeName":"IPD Store","storeType":"Sub Store","location":"4th Floor Wards","inCharge":"Sr. Betty","contactNumber":"1008","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":9,"storeCode":"STR-009","storeName":"General Store","storeType":"Main Store","location":"Basement Level 2","inCharge":"Mr. Verma","contactNumber":"1009","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":10,"storeCode":"STR-010","storeName":"Stationery Store","storeType":"Sub Store","location":"Admin Block","inCharge":"Ms. Neha","contactNumber":"1010","status":"Active","createdBy":"System","createdDate":"2024-01-01"}];

export const WarehouseMaster = () => {
  const [records, setRecords] = useState<WarehouseRecord[]>(mockData);
  ...
  const [formData, setFormData] = useState<Omit<WarehouseRecord, 'id'>>(emptyData);
  const validateForm = () => {
    if (!formData.storeCode.trim()) return false;
    if (!formData.storeName.trim()) return false;
    return true;
  };
    ...
    >
      ...
      <div className="mb-6">
        <div className="flex items-center text-sm text-slate-500 mb-2">
          ...
          <span className="text-primary font-medium">Store/Warehouse Master</span>
        </div>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-800">Store/Warehouse Master</h1>
            <p className="text-slate-500 mt-1">Manage Stores</p>
          </div>
          
          <div className="flex items-center gap-3">
            <Button variant="outline" icon={Download} onClick={() => exportToExcel(records, 'WarehouseMaster')}>Export</Button>
...
<td className="py-3 px-4 text-slate-800">{record.storeType}</td>
<td className="py-3 px-4 text-slate-800">{record.location}</td>
...
<div><label className="block text-sm font-medium text-slate-700 mb-1">Code</label><input type="text" value={formData.storeCode} onChange={(e) => setFormData({...formData, storeCode: e.target.value})} className="w-full px-4 py-2 border border-slate-200 rounded-xl text-sm outline-none focus:border-primary"/></div>
<div><label className="block text-sm font-medium text-slate-700 mb-1">Name</label><input type="text" value={formData.storeName} onChange={(e) => setFormData({...formData, storeName: e.target.value})} className="w-full px-4 py-2 border border-slate-200 rounded-xl text-sm outline-none focus:border-primary"/></div>
          <div>
