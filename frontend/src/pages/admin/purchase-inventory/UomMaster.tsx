...
const emptyData: Omit<UomRecord, 'id'> = { uomCode: '', uomName: '', shortName: '', status: 'Active' };

export const mockData: UomRecord[] = [{"id":1,"uomCode":"EA","uomName":"Each","shortName":"EA","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":2,"uomCode":"BOX","uomName":"Box","shortName":"BOX","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":3,"uomCode":"BTL","uomName":"Bottle","shortName":"BTL","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":4,"uomCode":"PCK","uomName":"Pack","shortName":"PCK","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":5,"uomCode":"PR","uomName":"Pair","shortName":"PR","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":6,"uomCode":"ROL","uomName":"Roll","shortName":"ROL","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":7,"uomCode":"STP","uomName":"Strip","shortName":"STP","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":8,"uomCode":"KIT","uomName":"Kit","shortName":"KIT","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":9,"uomCode":"SET","uomName":"Set","shortName":"SET","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":10,"uomCode":"LTR","uomName":"Litre","shortName":"L","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":11,"uomCode":"ML","uomName":"Millilitre","shortName":"ml","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":12,"uomCode":"GM","uomName":"Gram","shortName":"g","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":13,"uomCode":"KG","uomName":"Kilogram","shortName":"kg","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":14,"uomCode":"MG","uomName":"Milligram","shortName":"mg","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":15,"uomCode":"MCG","uomName":"Microgram","shortName":"mcg","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":16,"uomCode":"AMP","uomName":"Ampoule","shortName":"AMP","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":17,"uomCode":"VIAL","uomName":"Vial","shortName":"VIAL","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":18,"uomCode":"TUBE","uomName":"Tube","shortName":"TUBE","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":19,"uomCode":"SACHET","uomName":"Sachet","shortName":"SACHET","status":"Active","createdBy":"System","createdDate":"2024-01-01"},
{"id":20,"uomCode":"GAL","uomName":"Gallon","shortName":"GAL","status":"Active","createdBy":"System","createdDate":"2024-01-01"}];

export const UomMaster = () => {
  const [records, setRecords] = useState<UomRecord[]>(mockData);
  ...
  const [formData, setFormData] = useState<Omit<UomRecord, 'id'>>(emptyData);
  const validateForm = () => {
    if (!formData.uomCode.trim()) return false;
    if (!formData.uomName.trim()) return false;
    return true;
  };
  ...
  const handleToggleStatus = (record: UomRecord) => {
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-500 mt-1">Manage Unit of Measurement</p>
          </div>
          
          <div className="flex items-center gap-3">
            <Button variant="outline" icon={Download} onClick={() => exportToExcel(records, 'UomMaster')}>Export</Button>
...
<div><label className="block text-sm font-medium text-slate-700 mb-1">Code</label><input type="text" value={formData.uomCode} onChange={(e) => setFormData({...formData, uomCode: e.target.value})} className="w-full px-4 py-2 border border-slate-200 rounded-xl text-sm outline-none focus:border-primary"/></div>
<div><label className="block text-sm font-medium text-slate-700 mb-1">Name</label><input type="text" value={formData.uomName} onChange={(e) => setFormData({...formData, uomName: e.target.value})} className="w-full px-4 py-2 border border-slate-200 rounded-xl text-sm outline-none focus:border-primary"/></div>
<div><label className="block text-sm font-medium text-slate-700 mb-1">Short Name</label><input type="text" value={formData.shortName} onChange={(e) => setFormData({...formData, shortName: e.target.value})} className="w-full px-4 py-2 border border-slate-200 rounded-xl text-sm outline-none focus:border-primary"/></div>
          <div>
