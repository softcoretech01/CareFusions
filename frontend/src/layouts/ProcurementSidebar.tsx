...
import { LayoutDashboard, FileText, ShoppingBag, PackageCheck, Truck, FileSignature, ClipboardList, GitCompare, RotateCcw, CheckSquare, LogOut } from 'lucide-react';
import { motion } from 'framer-motion';
import { useAppDispatch } from '../hooks/redux';
import { logout } from '../redux/slices/authSlice';

const navigation = [
  { name: 'Dashboard', to: '/procurement', icon: LayoutDashboard },
  { name: 'Purchase Requisitions', to: '/procurement/pr', icon: FileText },
  { name: 'Request for Quotation', to: '/procurement/rfq', icon: FileSignature },
  { name: 'Vendor Quotation', to: '/procurement/quotation', icon: ClipboardList },
  { name: 'Quotation Comparison', to: '/procurement/quotation-comparison', icon: GitCompare },
  { name: 'Purchase Orders', to: '/procurement/po', icon: ShoppingBag },
  { name: 'Goods Receipt (GRN)', to: '/procurement/grn', icon: PackageCheck },
  { name: 'Purchase Return', to: '/procurement/purchase-return', icon: RotateCcw },
  { name: 'Vendors Catalog', to: '/procurement/vendors', icon: Truck },
  { name: 'Approvals', to: '/procurement/approvals', icon: CheckSquare },
];
