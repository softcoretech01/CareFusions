...
const navigation = [
  ...
  { name: 'Test Orders', to: '/lab/orders', icon: FlaskConical },
  { name: 'Critical Alerts', to: '/lab/alerts', icon: AlertTriangle },
  { name: 'Quality Control', to: '/lab/qc', icon: Activity },
  { name: 'Reports', to: '/lab/reports', icon: FileText },
];
