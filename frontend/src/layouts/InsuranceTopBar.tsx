  ...
  return (
    <header className="h-20 bg-white border-b border-slate-100 flex items-center justify-between px-8 sticky top-0 z-10 shadow-sm">
      ...
      <div className="flex-1 max-w-xl relative mx-8">
        ...
        <input
          type="text"
          placeholder="Search patient, claim ID, or policy number..."
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            <p className="text-sm font-bold text-slate-800">Insurance Officer</p>
            <p className="text-[10px] font-bold tracking-wider text-primary uppercase">TPA Team</p>
          </div>
